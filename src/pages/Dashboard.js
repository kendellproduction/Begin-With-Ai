    ...
    return (
      ...
      <div className="relative z-10">
        <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-6xl mx-auto">
              <div className="glass-primary rounded-3xl p-4 shadow-lg">
                ...
                <div className="space-y-2">
                  ...
                  <button onClick={() => newsSectionRef.current?.scrollIntoView({ behavior: 'smooth', block: 'start' })} className="w-full glass-button bg-gradient-to-r from-green-600 to-emerald-600 text-white p-2 rounded-xl hover:from-green-700 hover:to-emerald-700 transition-all duration-300 text-left flex items-center gap-2 text-sm"><span className="text-base">📰</span> AI News</button>
                </div>
              </div>
            ...
            <div ref={newsSectionRef} className="max-w-6xl mx-auto mt-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {newsArticles && newsArticles.map((article, idx) => (
                  ...
                  >
                    ...
                    <p className="mt-2 text-xs text-blue-200/90 italic">
                      In simple terms: This article covers {article.source || 'an AI source'}'s update on {article.category || 'AI developments'}.
                    </p>
                    </div>
                  </a>
                ))}
