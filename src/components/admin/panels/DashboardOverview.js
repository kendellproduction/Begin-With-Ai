...
const DashboardOverview = () => {
  ...
  const QuickActionCard = ({ title, description, icon: Icon, color, path, badge }) => (
    <Link to={path}>
      <motion.div
        whileHover={{ scale: 1.02, y: -2 }}
        className="bg-gray-800 border border-gray-700 rounded-lg p-4 hover:border-gray-600 transition-all duration-200 relative"
      >
        {badge && (
        ...
        <div className="lg:col-span-2 bg-gray-800 rounded-xl p-6 border border-gray-700">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <QuickActionCard
              ...
              description="Visual builder with templates"
            ...
            <QuickActionCard
              ...
              color="bg-green-600"
              path="/admin-unified?panel=content-management"
            />
            <QuickActionCard
              title="AI Tools"
              ...
              icon={SparklesIcon}
              color="bg-purple-600"
              path="/admin-unified?panel=ai-features"
              badge="New"
            />
            <QuickActionCard
              ...
              icon={ChartBarIcon}
              color="bg-amber-600"
              path="/admin-unified?panel=analytics"
            />
          </div>
        </div>
      </div>
